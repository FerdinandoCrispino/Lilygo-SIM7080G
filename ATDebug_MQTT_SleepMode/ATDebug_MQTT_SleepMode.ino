    ...
    */
    ...
    if (cfg.GPS_active) {
        ...
        while (1) {
          ...
          result_gps.trim();
          int commaIndex1 = result_gps.indexOf(',');
          int commaIndex2 = result_gps.indexOf(',', commaIndex1 + 1);
          int commaIndex3 = result_gps.indexOf(',', commaIndex2 + 1);
          int commaIndex4 = result_gps.indexOf(',', commaIndex3 + 1);
          int commaIndex5 = result_gps.indexOf(',', commaIndex4 + 1);
          int commaIndex6 = result_gps.indexOf(',', commaIndex5 + 1);
